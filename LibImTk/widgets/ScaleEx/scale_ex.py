...
class ScaleEx():
    def __init__(self, master):
        ...
        self.__changed_proc:callable = None
        ...
        self.__defaultbtn = tk.Button(self.__frame)
        self.__defaultbtn.configure(text='reset')
        self.__defaultbtn.pack(side="left")
    ...
    def __init_events(self):
        ...
        self.__defaultbtn.bind('<1>', self.__onClick_default)

    def __onClick_default(self, event):
        self.set(self.__default)
    ...
    def get_label(self)->str:
        return self.__lblframe['text']

    def bind(self, changed:callable=None):
        self.__changed_proc = changed

    def destroy(self):
        self.__lblframe.destroy()